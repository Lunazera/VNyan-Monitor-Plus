...
{
    public class MiniMonitor : MonoBehaviour, IDragHandler, IPointerDownHandler
    {
        ...
        [SerializeField] private TMP_Text parameterValueText;
        ...
        void Update()
        {
            parameterValueText.text = getParamValue().ToString("0.000");
        }
